...
\providecommand{\numofalgs}{1}
\providecommand{\algname}{dfogn.dfogn of dfogn 2D on bbob trust=1{}}
\providecommand{\algfolder}{dfogn.dfogn_of_dfogn_2D_on_bbob_trust=1/}
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6.3}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{dfogn.dfogn of dfogn 50D on bbob trust=1{}}
\providecommand{\algfolder}{dfogn.dfogn_of_dfogn_50D_on_bbob_trust=1/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6.3}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{dfogn.dfogn of dfogn 50D on bbob trust=0-001{}}
\providecommand{\algfolder}{dfogn.dfogn_of_dfogn_50D_on_bbob_trust=0-001/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
